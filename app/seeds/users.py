...
def seed_users():
    ...
    Bella = User(
        first_name='Bella', last_name='Poarch', image_url='https://drive.google.com/file/d/1IYEmjDxs-c-IVvIxpXAqy5jqLYMmQASw/view?usp=sharing', bio='No bio yet.', username='bellapoarch', email='bella@aa.io', password='password')
    Will = User(
        first_name='Will', last_name='Smith', image_url='https://p16-sign-va.tiktokcdn.com/musically-maliva-obj/1646315618666501~c5_720x720.jpeg', username='willsmith', email='will@aa.io', password='password')
    Zach = User(
        first_name='Zach', last_name='King', image_url='https://p16-sign-sg.tiktokcdn.com/aweme/720x720/tos-alisg-avt-0068/smgf5f369c884044a8df770614bbfd64717.jpeg', username='zachking', email='zach@aa.io', password='password')
    Khaby = User(
    ...
    Rock = User(
        first_name='The', last_name='Rock', image_url='https://p16-sign-va.tiktokcdn.com/musically-maliva-obj/1647596478025734~c5_720x720.jpeg', username='therock', email='rock@aa.io', password='password')
